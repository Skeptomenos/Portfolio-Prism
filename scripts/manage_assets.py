...
Examples:
  ...
  python scripts/manage_assets.py remove --isin US0378331005
    ...
    add_parser.add_argument(
        "--isin", required=True, help="ISIN code (e.g., US0378331005)"
    )
    ...
    add_parser.add_argument(
        "--tr-ticker", help="Trade Republic ticker (defaults to Yahoo ticker)"
    )
    ...
    search_parser.add_argument(
        "--field",
        choices=["ISIN", "Name", "Provider", "Yahoo_Ticker", "Asset_Class"],
