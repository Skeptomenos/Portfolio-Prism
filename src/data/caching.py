...
def _load_json_cache():
    ...
    try:
        ...
        logger.error(f"Corrupt cache file at {ENRICHMENT_CACHE_FILE}. Returning empty cache.")
        return {}
    ...
    def decorator(func):
        ...
        def wrapper(self, isin: str, *args, **kwargs):
            ...
            if not result_df.empty:
                ...
                logger.warning(f"Adapter {class_name} returned an empty DataFrame for {isin}. Not caching.")
