...
def validate_final_report(positions_df: pd.DataFrame, report_df: pd.DataFrame) -> bool:
    ...
    if 'asset_type' in positions_df.columns:
        ...
        print("  - ⚠️ SKIPPED: Completeness Check (Missing 'asset_type' in positions data)")
...
if __name__ == '__main__':
    ...
    mock_report_success['total_exposure'] = mock_report_success['direct'] + mock_report_success['indirect']
