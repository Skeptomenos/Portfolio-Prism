...
def generate_direct_holdings_report(all_positions: pd.DataFrame, output_path: str = "outputs/direct_holdings_report.csv"):
    """
    ...
    cols_to_keep = [
        'isin', 'name', 'ticker_src', 'asset_type', 
        'quantity', 'current_price', 'market_value', 
        'portfolio_weight', 'provider'
    ]
