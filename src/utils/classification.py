...
def classify_holding(ticker: str, name: str) -> str:
    ...
    # 1. Cash / Money Market
    cash_keywords = ["_CURRENCY", "LIQUIDITY", "CASH", "MONEY MARKET", "AUD CASH", "USD CASH", "EUR CASH"]
    if any(k in ticker_upper for k in cash_keywords) or any(k in name_upper for k in cash_keywords):
        return "Cash"
    ...
    if "FUT" in ticker_upper or "FUTURE" in name_upper or "INDEX DEC" in name_upper or "INDEX MAR" in name_upper:
        return "Derivative"
